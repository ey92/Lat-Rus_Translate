...
print(Russian.decline('друг','NOM','PL'))
print(Russian.decline('друг','GEN','PL'))
print(Russian.decline('друг','DAT','PL'))
print(Russian.decline('друг','ACC','PL'))
print(Russian.decline('друг','PRP','PL'))
print(Russian.decline('друг','INS','PL'))
print(Russian.decline('друг','NOM','SG'))
print(Russian.decline('друг','GEN','SG'))
print(Russian.decline('друг','DAT','SG'))
print(Russian.decline('друг','ACC','SG'))
print(Russian.decline('друг','PRP','SG'))
print(Russian.decline('друг','INS','SG'))