...
print(Russian.decline('имя','NOM','PL'))
print(Russian.decline('имя','GEN','PL'))
print(Russian.decline('имя','DAT','PL'))
print(Russian.decline('имя','ACC','PL'))
print(Russian.decline('имя','PRP','PL'))
print(Russian.decline('имя','INS','PL'))
print(Russian.decline('имя','NOM','SG'))
print(Russian.decline('имя','GEN','SG'))
print(Russian.decline('имя','DAT','SG'))
print(Russian.decline('имя','ACC','SG'))
print(Russian.decline('имя','PRP','SG'))
print(Russian.decline('имя','INS','SG'))