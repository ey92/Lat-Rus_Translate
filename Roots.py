...
RussianV = [
    ...
    ('ходить',     'ходят',      '1v',  'сходить',      'сходят',       '1v', 'to walk'         ), \
    ...
    ('играть',     'играют',     '1v',  'поиграть',     'поиграют',     '1v', 'to play',        ), \
    ('приходить',  'приходят',   '2v',  'прийти',       'придут',       '1c', 'to come',        ), \
    ('начинать',   'начинают',   '1v',  'начать',       'начнут',       '1c', 'to begin',       ), \
]
